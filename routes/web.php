...
Route::group(['middleware' => ['auth', 'verified', '2fa']], function () {
    ...
    Route::group(['middleware' => ['role:administrador|coordinador|rector|jefe de proyecto']], function () {
        ...
        Route::get('/sales/{sale}/pdf', [SaleController::class, 'generatePdf'])->name('sales.generatePdf');

        
        Route::get('/sales/pdf', [SaleController::class, 'exportAllPDF'])->name('sales.export-pdf');
