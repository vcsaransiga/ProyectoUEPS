    ...
    <div class="container">
        ...
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    @foreach ($measurementUnits as $measureUnit)
                        <tr>
                            <td class="tw-px-6 tw-py-4">{{ $measureUnit->id_unit }}</td>
                            <td class="tw-px-6 tw-py-4">{{ $measureUnit->name }}</td>
                            <td class="tw-px-6 tw-py-4">{{ $measureUnit->symbol }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
